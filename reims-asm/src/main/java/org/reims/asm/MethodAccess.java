...
public abstract class MethodAccess {
    ...
    static public MethodAccess get(Class<?> type) {
        ...
        accessClassName = ReflexAsmClassUtil.rebuildClassName(accessClassName);
        ...
        if (accessClass == null) {
            synchronized (loader) {
                ...
                if (accessClass == null) {
                    ...
                    MethodVisitor mv;
                    cw.visit(V11, ACC_PUBLIC + ACC_SUPER, accessClassNameInternal, null, "org/reims/asm/MethodAccess", null);
                    {
                        mv = cw.visitMethod(ACC_PUBLIC, "<init>", "()V", null, null);
                        mv.visitCode();
                        mv.visitVarInsn(ALOAD, 0);
                        mv.visitMethodInsn(INVOKESPECIAL, "org/reims/asm/MethodAccess", "<init>", "()V", false);
                        mv.visitInsn(RETURN);
                        mv.visitMaxs(0, 0);
                        mv.visitEnd();
                    }
